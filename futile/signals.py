...
def _sigterm_handler(signum, frame):
    sys.exit(0)
_sigterm_handler._enter_context = False


@contextlib.contextmanager
def handle_exit(callback=None, append=True, sig=signal.SIGTERM):
    """
    ...
    _sigterm_handler._enter_context = True
...
if __name__ == "__main__":
    ...
    class TestOnExit(unittest.TestCase):
        ...
        def test_no_append(self):
            ...
            try:
                with handle_exit(lambda: self.flag.append(None), append=False):
                    pass
            except RuntimeError:
                pass
            else:
