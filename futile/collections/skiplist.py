...
class LinkedList(object):
    ...
    def __getitem__(self, offset):
        if offset < 0:
            raise IndexError("Can't do negative offsets with a singly linked list.")
...
class SortedLinkedList(LinkedList):
    ...
    def insert_after(self, existing_node, new_node):
        ...
        return super(SortedLinkedList, self).insert_after(existing_node, new_node)
