...
see: https://github.com/noamraph/tqdm/blob/master/LICENSE
"""
...
def progressed(iterable, desc='', total=None, leave=False, file=sys.stderr,
...
def prange(*args, **kwargs):
    """A shortcut for writing progressed(range())"""
    return progressed(range(*args), **kwargs)
